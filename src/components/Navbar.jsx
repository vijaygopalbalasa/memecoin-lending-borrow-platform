...
export default function Navbar() {
    ...
    const { user, login, logout } = useWeb3Auth();
                ...
                <div className="flex justify-between h-16">
                    ...
                    <div className="hidden sm:flex sm:items-center sm:space-x-8">
                        ...
                        {user ? (
                            <button
                                onClick={logout}
                                className="bg-gradient-to-r from-primary-500 to-secondary-500 text-white px-4 py-2 rounded-lg font-medium hover:from-primary-600 hover:to-secondary-600"
                            >
                                Disconnect
                            </button>
                        ) : (
